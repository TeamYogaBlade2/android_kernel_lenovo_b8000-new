...
CUSTOM_KERNEL_LCM = cm_hx8896a01_dsi_vdo cm_hx8896a01_dsi_vdo_boe dummy
...
DOLBY_DAP = yes
DOLBY_DAP_BYPASS_SOUND_TYPES = yes
DOLBY_DAP_OPENSLES = yes
DOLBY_UDC = yes
...
MTK_IMEI_LOCK = no
MTK_IME_ARABIC_SUPPORT = yes
MTK_IME_ENGLISH_SUPPORT = yes
MTK_IME_FRENCH_SUPPORT = yes
MTK_IME_GERMAN_SUPPORT = yes
MTK_IME_HANDWRITING_ENGINE = hanwang
MTK_IME_HANDWRITING_SUPPORT = yes
MTK_IME_HINDI_SUPPORT = yes
MTK_IME_INDONESIAN_SUPPORT = yes
MTK_IME_INPUT_ENGINE = xt9
MTK_IME_ITALIAN_SUPPORT = yes
MTK_IME_MALAY_SUPPORT = yes
MTK_IME_PINYIN_SUPPORT = yes
MTK_IME_PORTUGUESE_SUPPORT = yes
MTK_IME_RUSSIAN_SUPPORT = yes
MTK_IME_SPANISH_SUPPORT = yes
MTK_IME_STROKE_SUPPORT = yes
MTK_IME_SUPPORT = yes
MTK_IME_THAI_SUPPORT = yes
MTK_IME_TURKISH_SUPPORT = yes
MTK_IME_VIETNAM_SUPPORT = yes
...
MTK_PRODUCT_LOCALES = en_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG hi_IN th_TH bn_IN pt_PT ur_PK fa_IR nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ hdpi ldpi mdpi xhdpi
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_tablet rel_customer_platform_mt6589
